...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 551, 521))
        ...
        self.edit_pushButton_2 = QtWidgets.QPushButton(self.gridWidget)
        self.edit_pushButton_2.setObjectName("edit_pushButton_2")
        self.verticalLayout.addWidget(self.edit_pushButton_2)
        self.delete_pushButton_3 = QtWidgets.QPushButton(self.gridWidget)
        self.delete_pushButton_3.setObjectName("delete_pushButton_3")
        self.verticalLayout.addWidget(self.delete_pushButton_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edit_pushButton_2.setText(_translate("MainWindow", "Edit..."))
        self.delete_pushButton_3.setText(_translate("MainWindow", "Delete..."))
